...
| 2   | UI                       | Nama Tim / Pemesan, Nomor WhatsApp, notes, payment info card, proof upload control, honeypot                                                                                                                                                                                                                                                                                                                                                              |
...
- Fields: **Nama Tim / Pemesan** (required), Nomor WhatsApp (required, accepts `08xx` / `62xx` / `+62xx`, **normalised to `628xxxxxxxxx` before storage**), notes (optional, **max 500 characters**)
