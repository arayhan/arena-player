...
- Payment info card: the account list **read from `GET /api/payment-accounts`** since 2026-08-15, plus the instruction text "Transfer DP 50% dari harga sewa. Nominal dikonfirmasi admin via WhatsApp."
