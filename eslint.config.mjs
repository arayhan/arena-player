...
const eslintConfig = defineConfig([
  ...
  // public/ is static assets served as-is, not source. mockServiceWorker.js in
  // particular is generated by `msw init` and regenerated on every install —
  // linting it reports on vendor code nobody here writes or can fix.
